...
import { BottomNavigation, BottomNavigationAction, Box, Button, Dialog, IconButton, List, ListItem, ListItemText, Paper, Stack } from '@mui/material'
...
export const BottomNavigationComponent: React.FC<Props> = ({ isOpen, handleClick }) => {
  return <Box>
    <Paper sx={{ position: 'fixed', bottom: 0, left: 0, right: 0, display: { xs: 'block', sm: 'block', md: 'none' } }} elevation={3}>
      ...
      >
        ...
        <BottomNavigationAction onClick={handleClick} label="Меню" icon={<Menu />} />
      </BottomNavigation>
    </Paper>
    <Dialog
      fullScreen
