...
export const PreviewCard: React.FC<Props> = ({ usedId, item }) => {
  ...
  return <PreviewCardComponent usedId={usedId} item={item} handleClick={handleClick} colors={{ icon, red }} useDate={useDate} />
}